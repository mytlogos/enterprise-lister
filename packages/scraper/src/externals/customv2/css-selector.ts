// this code was modified from https://raw.githubusercontent.com/antonmedv/finder/master/finder.ts to work in node
...
export function finder(input: Element, options?: Partial<Options>) {
  if (input.nodeType !== NodeType.ELEMENT_NODE) {
...
function findRootDocument(rootNode: Element | Document, defaults: Options) {
  if (rootNode.nodeType === NodeType.DOCUMENT_NODE) {
    return rootNode;
  }
...
function maybe(...level: Array<Node | null>): Node[] | null {
