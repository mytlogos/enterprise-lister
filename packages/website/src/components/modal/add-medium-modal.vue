<template>
  <modal :error="error" :show="show" @finish="send()">
    <template #title> Add Medium </template>
    <template #input>
      <div class="title">
        <label>
          Title:
          <input v-model="medium.title" name="title" required title="Title" type="text" />
        </label>
      </div>
      <div class="medium">
        <label>Medium:</label>
      ...
      <div class="author autocomplete">
        <label>
          Author:
          <input v-model="medium.author" name="author" title="Author" type="text" />
        </label>
      </div>
      <div class="artist autocomplete">
        <label
          >Artist:
          <input v-model="medium.artist" name="artist" title="Artist" type="text" />
        </label>
      </div>
      <div class="series autocomplete">
        <label
          >Series:
          <input v-model="medium.series" name="series" title="Series" type="text" />
        </label>
      </div>
      <div class="universe autocomplete">
        <label
          >Universe:
          <input v-model="medium.universe" name="universe" title="Universe" type="text" />
        </label>
      </div>
      <div class="language autocomplete">
        <label
          >Language:
          <input v-model="medium.language" name="language" title="Language" type="text" />
        </label>
      </div>
      <div class="countryOfOrigin autocomplete">
        <label
          >Country Of Origin:
          <input v-model="medium.countryOfOrigin" name="countryOfOrigin" title="Country Of Origin" type="text" />
        </label>
      </div>
      <div class="langOfOrigin autocomplete">
        <label
          >Language Of Origin:
          <input v-model="medium.langOfOrigin" name="langOfOrigin" title="Language Of Origin" type="text" />
        </label>
      </div>
      <div class="stateTl autocomplete">
        <label
          >Status of Translator:
          <input v-model="medium.stateTl" name="stateTl" title="Status of Translator" type="text" />
        </label>
      </div>
      <div class="stateCOO autocomplete">
        <label
          >Status in COO:
          <input v-model="medium.stateCOO" name="stateCOO" title="Status in COO" type="text" />
        </label>
      </div>
