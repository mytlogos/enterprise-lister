...
describe("testing tool.js", () => {
  ...
  describe("test promiseMultiSingle", function () {
    it("should always return a promise", function () {
      return Promise.all([
        ...
        tools
          // @ts-expect-error
          .promiseMultiSingle(null, null)
          .catch(empty)
          .should.be.a("promise"),
        tools
          // @ts-expect-error
          .promiseMultiSingle([], null)
          .catch(empty)
          .should.be.a("promise"),
  ...
  describe("test countOccurrence", function () {
    it("should work correctly", () => {
      ...
      [...result.entries()].sort().should.deep.equal([
        [null, 3],
        [1, 1],
        [2, 1],
        [3, 1],
  ...
  describe("test allTypes", function () {
    it("should work correctly", () => {
      ...
      tools
        .allTypes()
        .should.equal(tools.MediaType.AUDIO | tools.MediaType.IMAGE | tools.MediaType.VIDEO | tools.MediaType.TEXT);
    });
  });
