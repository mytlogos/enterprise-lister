...
class UserContext extends subContext_1.SubContext {
    /**
    ...
    async register(userName, password, ip) {
        ...
        await this.parentContext.internalListContext.addList(id, { name: standardListName, medium: tools_1.allTypes() });
    ...
    _getUser(uuid, session) {
        ...
        const allExternalUserPromise = this
            ...
            return Promise.all(allExternalUser.map((value) => this.parentContext.externalUserContext
